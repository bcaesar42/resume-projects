...
public class DragDropFiles extends JFrame {
    ...
    private static DefaultTreeModel getDefaultTreeModel() {
        ...
        List<Bucket> MyBuckets = s3.listBuckets();
        
        for (Bucket buck: MyBuckets)
        {
        	parent = new DefaultMutableTreeNode(buck.getName());
        	root.add(parent);
        	ObjectListing objectListing = s3.listObjects(new ListObjectsRequest()
                    .withBucketName(buck.getName()));
    ...
    public DragDropFiles() {
            ...
            public boolean importData(TransferHandler.TransferSupport info) {            	
                ...
                try {
                    ...
                    for (File f : l) {
                    		...
                    		//copyFile(f, destFile);
                    		 s3.putObject(new PutObjectRequest(path.toString(), uploadName, f));
        ...
        download.addActionListener(new ActionListener() { 
        	  public void actionPerformed(ActionEvent e) { 
        	    ...
        	    {     	    		
        	    		Object[] path = downloadPath.getPath();
        	            S3Object object = s3.getObject(new GetObjectRequest(downloadPath.getPathComponent(path.length-2).toString(),
